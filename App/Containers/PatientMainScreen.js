...
import {Text, View, TouchableOpacity, StyleSheet, Dimensions, ScrollView, Image, Keyboard, TouchableWithoutFeedback, TextInput } from 'react-native';
...
class PatientMainScreen extends PureComponent {
  ...
  aboutEditView = User => {
    ...
    const obj = [{
      inputTitle: "@Name",
      fieldName: "name",
      placeholder: "eg. Naseebullah Ahmadi",
      overrideStyle: null
    },{
      inputTitle: "@Bio",
      fieldName: "bio",
      placeholder: "eg. About yourself",
      overrideStyle: "overrideInput"
    },{
      inputTitle: "@Address",
      fieldName: "address",
      placeholder: "eg. 122 AtherStone",
      overrideStyle: null
    },{
      ...
      placeholder: "eg. 05726293724",
      overrideStyle: null
    },{
      inputTitle: "@Date of birth",
      fieldName: "DOB",
      placeholder: "eg. 02/06/1997",
      overrideStyle: null
    },{
      inputTitle: "@Age",
      fieldName: "age",
